...
function addChat(sender, message, style = "normal") {
    ...
    let bubbleClass = "bg-neutral-800 text-neutral-200 border border-white/10";
    if (sender === "You") bubbleClass = "bg-white text-black";
    else if (style === "booking") bubbleClass = "bg-neutral-900 text-neutral-100 border border-white/20";
